...
@startuml
' Behälter-Klasse (vereinfachte Darstellung)
class Behälter {
  + Dictionary<string, int> GetTagCounters()
  + bool istBraunerZucker
  + bool istBraunerZucker2
  + bool istWeißerZucker
  + bool istWeißerZucker2
  + bool istSalz
  + bool istPfeffer
  + bool istEiswürfel
  + bool istCrushedIce
...
' Assoziationen
TestDetecter --> DrinkDisplayUI : nutzt
TestDetecter --> Behälter : evaluiert/holt aus Collider
DrinkDisplayUI --> Behälter : verwendet
@enduml
